...
#        print(self.pct_dst_stdev)
    ...
    def save_all_plots(self):
        sets_to_plot = [
            ...
            ("Row Vertical Offset from Img Bottom (px)", "Row Coefficient of Variation", "Coefficient of Variation per Row", self.row_coeff_var),
        ...
        for set in sets_to_plot:
            ...
            axis.scatter(set[3], yaxis)
            axis.set_xlabel(set[1])
            axis.set_ylabel(set[0])
            axis.set_title(set[2])
            figure.tight_layout()
